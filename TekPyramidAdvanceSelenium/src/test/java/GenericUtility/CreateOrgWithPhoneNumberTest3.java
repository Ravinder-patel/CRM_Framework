...
public class CreateOrgWithPhoneNumberTest3 {
	public static void main(String[] args) throws Throwable {
		...
		String OrgName = sh.getRow(3).getCell(2).toString() + randomInt;
		String OrgIndustry = sh.getRow(3).getCell(3).toString();
		String OrgType = sh.getRow(3).getCell(4).toString();
		String OrgPhone = sh.getRow(3).getCell(5).toString()+randomInt;
		wb.close();
